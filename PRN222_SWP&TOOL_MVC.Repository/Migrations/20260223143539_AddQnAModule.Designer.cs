...
namespace PRN222_SWP_TOOL_MVC.Repository.Migrations
{
    ...
    [Migration("20260223143539_AddQnAModule")]
    partial class AddQnAModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN222_SWP_TOOL_MVC.Repository.Entities.Question", b =>
                {
                    ...
                    b.Property<int?>("LastRepliedByUserId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LastRepliedByUserId");
                    ...
                    b.HasIndex("TopicID", "Status", "LastReplyAt")
                        .HasDatabaseName("IX_Questions_TopicID_Status_LastReplyAt");

                    b.ToTable("Questions");
                });

            modelBuilder.Entity("PRN222_SWP_TOOL_MVC.Repository.Entities.QuestionMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PRN222_SWP_TOOL_MVC.Repository.Entities.Question", b =>
                {
                    ...
                    b.HasOne("PRN222_SWP_TOOL_MVC.Repository.Entities.User", "LastRepliedBy")
                        .WithMany()
                        .HasForeignKey("LastRepliedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("PRN222_SWP_TOOL_MVC.Repository.Entities.QuestionMessage", b =>
                {
                    b.HasOne("PRN222_SWP_TOOL_MVC.Repository.Entities.Question", "Question")
                        .WithMany("Messages")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PRN222_SWP_TOOL_MVC.Repository.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("PRN222_SWP_TOOL_MVC.Repository.Entities.Topic", b =>
                {
                    b.Navigation("TopicRegistrations");
                });
